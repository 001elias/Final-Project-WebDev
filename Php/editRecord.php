...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	// validating the form
	if (is_null($_POST['txtIsbn'])) $errorMessages .= "ISBN is required <br>";
	else $txtIsbn = $_POST['txtIsbn'];

  if (is_null($_POST['txtTitle'])) $errorMessages .= "Book Title is required <br>";
	else $txtTitle = $_POST['txtTitle'];

  if (is_null($_POST['selCategory'])) $errorMessages .= "Category is required <br>";
	else $selCategory = $_POST['selCategory'];

  if (is_null($_POST['txtAuthor'])) $errorMessages .= "Author Name is required <br>";
	else $txtAuthor = $_POST['txtAuthor'];

  if (is_null($_POST['txtStock'])) $errorMessages .= "Stock is required <br>";
	else $txtStock = $_POST['txtStock'];

  if (is_null($_POST['txtPrice'])) $errorMessages .= "Unit Price is required <br>";
	else $txtPrice = $_POST['txtPrice'];
  $txtDes = $_POST['txtDes'] ?? "";
